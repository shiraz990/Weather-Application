package com.application.weatherapp.helper
...
import com.application.weatherapp.callBacks.CustomListener
...
class UiHelper(private val context: Context) {
    ...
    fun accessLocationDialogWithListener(
        ...
        listener: CustomListener, positiveText: String,
    ...
    fun sortTimeStamp(list: ArrayList<WeatherEntity>) =
